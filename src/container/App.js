...
import { AsyncVideoInsructionComponent } from '../components/AsyncComponent/AsyncComponent';
	...
	render() {
		...
		if (location.pathname === '/') {
			if (user === null) {
				...
				return (<Redirect to={'/app/patient-referral'} />);
			}
		}
		return (
			<RctThemeProvider>
				...
				<Route path="/video-instruction" component={AsyncVideoInsructionComponent} />
