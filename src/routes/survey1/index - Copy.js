			...
			<div className="user-management">
				...
				<RctCollapsibleCard fullBlock>
					<div className="table-responsive">
						<div className="d-flex justify-content-between py-20 px-10 border-bottom">
							<div className="ml-10">
								<h2 className="mb-0">Survey List</h2>
							</div>
							<div>
								<a href="javascript:void(0)" onClick={() => this.opnAddNewUserModal()} color="primary" className="caret btn-sm mr-10">Add Survey List <i className="zmdi zmdi-plus"></i></a>
							</div>
						</div>
				...
				<Modal isOpen={this.state.addNewUserModal} toggle={() => this.onAddUpdateUserModalClose()}>
					<ModalHeader toggle={() => this.onAddUpdateUserModalClose()}>
						{editUser === null ?
							'Add New Survey List' : 'Update Survey List'
						}
					</ModalHeader>
					<ModalBody>
						{editUser === null ?
...
const mapStatetoProps = ({redcuerApp}) =>{
   const {loading} = redcuerApp;
   return {loading}
}

export default connect(mapStatetoProps, {})(Servey)
